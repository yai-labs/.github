...
<p align="center">
  <code>before action</code> judgment<br />
  <code>during action</code> control<br />
  <code>after action</code> evidence
</p>

YAI takes that lifecycle as its organizing principle.
